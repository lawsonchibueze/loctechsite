        ...
        <div className='bg-[#f8f8f8]'>
            <div className='flex flex-col gap-12 mt-10 lg:p-20 px-4 py-10 relative'>
                <div className='flex flex-col gap-6 items-center'>
                    <h1 className='text-base font-bold text-violet-700 borde leading-snugr'>TESTIMONIALS</h1>
                    <p className='text-[#181818] text-3xl font-medium text-center'>See What Our Students Have To Say</p>
                </div>
                <div className='overflow-hidden flex flex-col'>
                    <div className="flex lg:flex-row flex-col gap-10 transition-all duration-1000 ease-in-out" style={{ transform: `translateX(-${currentSlide * 100}vw)` }}>
                        {testimonials.map((testimonial, index) => {
                            return (
                                ...
                                >
                                    ...
                                    />
                                    <h2 className='text-violet-700 font-medium text-[18px]'>Great quality!</h2>
                                    <p className='text-[#696969] font-light leading-loose text-[16px]'>{testimonial.Feedback.substring(0, 150)}</p>
