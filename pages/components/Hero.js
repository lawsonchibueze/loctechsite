    ...
    <div className="flex flex-col bg-[#f8f8f8] pt-20">
      <div className="flex justify-between lg:px-32 px-4 flex-col lg:flex-row">
        <div className="flex flex-col gap-5 flex-1 ">
          <h2 className="text-violet-700 text-xl lg:text-start text-center font-semibold tracking-widest">IT Scholarship 2023</h2>
          <p className="font-semibold text-4xl leading-snug lg:w-3/4">
            Register for our IT scholarship for this year and use this opportunity to learn any IT course of your choice.
          </p>
          <h3 className="text-gray-900 text-xl">Click below to register for January Batch</h3>
          <a
          ...
          >
            <button className="bg-violet-700 text-white font-semibold rounded-sm lg:w-60 py-3 px-6 lg:px-0 text-xl hover:shadow-lg transition-shadow duration-500 ease-linear">Register Now</button>
          </a>
        </div>
      ...
      <div className="bg-violet-900 flex flex-col lg:flex-row justify-between lg:px-32 px-4 py-6 mt-14 gap-8 lg:gap-0">
