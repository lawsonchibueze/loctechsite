        ...
        <div className="flex flex-col gap-8">
          ...
          <div className=" leading-relaxed grid lg:grid-cols-3 grid-flow-row gap-20">
            <div className="flex flex-col gap-4 flex-1 lg:col-span-2">
              <h1 className="text-[20px] font-medium text-[#252525]">
                About The Event
              </h1>
              <p className="text-[14px] text-[#696969]">{event.content}</p>
            </div>
            <div className="w-full shadow-xl rounded-md p-8 h-fit flex flex-col gap-7">
              <div className="flex flex-row justify-between border-b pb-3">
                ...
                <span className="text-[24px] text-[#d31819] font-semibold">
              ...
              <div className="flex flex-row justify-between border-b pb-3">
                ...
                <span className="text-[14px] text-[#696969] font-light">
                  {event.totalSlot}
                </span>
              </div>
              <div className="flex flex-row justify-between border-b pb-3">
          ...
          <div>
            <form className="mt-10 flex flex-col gap-4">
              ...
              <button className="py-3 px-4 bg-violet-700 text-white rounded-md font-bold lg:w-40 hover:border hover:border-gray-200 hover:bg-white hover:text-violet-700 transition-colors duration-500 ease-in-out">
                Submit
              </button>
            </form>
          </div>
