      ...
      <div className="relative">
        ...
        <div className="flex flex-col gap-10 bg-white lg:px-40 px-4 py-10">
          ...
          <div>
            ...
            <div className="grid lg:grid-cols-2 grid-flow-row lg:w-[70%] gap-4 lg:border lg:p-4 lg:rounded-md">
              {course.learningObjective.map((item, index) => {
                return (
                  <div
                    key={index}
                    className="text-[#696969] font-light text-[14px] flex flex-row gap-2 items-start justify-center"
                  >
          ...
          <div>
            ...
            <a
              ...
              download
            >
              <button className="bg-red-700 text-white font-medium px-4 py-3 rounded-md">
                Download Curriculum
              </button>
            </a>
          </div>
          <div>
            ...
            <div className="flex lg:flex-row flex-col gap-7">
              ...
              <div className="flex flex-col gap-2  flex-1">
                <Link href="/instructor" className="text-2xl font-medium">
                  {course.instructorName}
                </Link>
                ...
                <div className="flex flex-row gap-4 lg:gap-7">
                  <span className="flex flex-row gap-1 items-center text-gray-500 font-medium">
                    <BsPlayCircle className="w-5 h-5" />5 Courses
                  </span>
                  <span className="flex flex-row gap-1 items-center text-gray-500 font-medium">
                    <FiMessageSquare className="w-5 h-5" />4 Reviews
                  </span>
                  <span className="flex flex-row gap-1 items-center text-gray-500 font-medium">
                ...
                <div className="flex flex-row gap-10">
                  <a href="">
                    <FaFacebookF className="w-5 h-5 text-violet-700" />
                  </a>
                  <a href="">
                    <FaTwitter className="w-5 h-5 text-violet-700" />
                  </a>
                  <a href="">
                    <FaInstagram className="w-5 h-5 text-violet-700" />
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="lg:absolute lg:right-40 lg:top-28 h-fit lg:z-10 bg-white rounded-md shadow-lg flex flex-col gap-4 px-4 lg:px-0">
          ...
          <div className="lg:px-6 px-2 py-3 flex flex-col gap-2">
            ...
            <div
              className={
                course.level === "All Levels"
                  ? "text-[#17b8c1] bg-[#17b8c128] self-start py-0.5 px-2 rounded-md"
                  : ""
              }
            >
              {course.level}
            ...
            <button className="bg-violet-700 w-full py-3 font-medium text-white rounded-md text-lg hover:shadow-xl duration-300 ease-in-out">
              Start Learning
            </button>
          </div>
        </div>
